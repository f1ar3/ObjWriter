package ru.vsu.cs.zagorodnev_g_a.Test;
...
public class ObjWriterTest {
    ...
    void getVertexes() {
        ...
        vs.add(v1);
        String res = ObjWriter.writeVertices(vs);
    ...
    void getTextureVertexes() {
        ...
        vt.add(v1);
        String res = ObjWriter.writeTextureVertices(vt);
        String expected = "vt 1.0000 2.2000\n" + "№ 1 texture coords" + "\n\n";
        Assertions.assertEquals(expected, res);
    }
